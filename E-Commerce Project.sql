...
ALTER COLUMN order_date date; -- text ten nvarchar a ondan date e çevirdim
...
where [1] >0 and [2] > 0 and [3] > 0 and [4] > 0 -- but the question asks to return the customer who purchased in all months
